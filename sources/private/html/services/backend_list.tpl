{if $backend->enabled === false}
	<p class="alert alert-info">Le backend {$backend->fullname} n'est pas activé dans la <a href="{$smarty.const.URL}/index.php/configuration/avancee">page de configuration</a>.</p>
{/if}
