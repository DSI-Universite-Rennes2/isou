<form action="{$smarty.const.URL}/index.php/services/{$backend->url}/delete/{$service->id}" method="post">
	<div class="text-center alert alert-danger">
		...
		<ul class="list-inline form-submit-buttons-ul">
			...
			<li>
				<a class="btn btn-default" href="{$smarty.const.URL}/index.php/services/{$backend->url}">annuler</a>
			</li>
		</ul>
	</div>
</form>
