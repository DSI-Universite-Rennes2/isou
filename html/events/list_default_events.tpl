<table class="caption-top table table-bordered table-condensed">
	...
	<tbody>
		...
		<tr>
			...
			<td headers="lth4" class="table-danger text-danger">en cours</td>
			{else}
			...
			<td headers="lth6">
				<ul class="list-inline">
					<li class="list-inline-item"><a class="btn btn-sm btn-success" href="{$smarty.const.URL}/index.php/evenements/{$eventtype}/more/{$event->id}">détails</a></li>
