	...
	<fieldset>
		...
		<dl>
			<div class="form-group">
				<dt class="form-topics-dt" id="plugin-shinken-enable">Activer</dt>
				<dd class="form-values-dd">
					{html_radios aria-labelledby="plugin-shinken-enable" name="plugin_shinken_enable" options=$options_yes_no selected=$plugin->active}
				</dd>
			</div>
