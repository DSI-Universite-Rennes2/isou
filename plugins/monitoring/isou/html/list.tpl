		...
		<tbody>
			...
			<tr{if !empty($service->css)} class="{$service->css}"{/if}>
				...
				<ul class="list-inline">
					<!-- <li class="list-inline-items"><a class="btn btn-sm btn-secondary" href="{$smarty.const.URL}/index.php/services/isou/inspect/{$service->id}">inspecter</a></li> -->
					<li class="list-inline-items"><a class="btn btn-sm btn-primary" href="{$smarty.const.URL}/index.php/services/isou/edit/{$service->id}">modifier</a></li>
					<li class="list-inline-items"><a class="btn btn-sm btn-danger" href="{$smarty.const.URL}/index.php/services/isou/delete/{$service->id}">supprimer</a></li>
				</ul>
				</td>
